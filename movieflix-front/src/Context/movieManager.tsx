...
import type { MoviePreviewInterface } from "../pages/movieManagerPage";

type MovieManagerContextType = {
  categories: Category[];
...
export const MovieManagerContext = createContext<MovieManagerContextType>(
  {} as MovieManagerContextType
);
